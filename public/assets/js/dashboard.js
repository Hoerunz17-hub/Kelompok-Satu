    ...
    $(function () {
        ...
        if ($("#total-profit-dark").length) {
            var graphGradient = document
                .getElementById("total-profit-dark")
                .getContext("2d");
            ...
            var barChartCanvas = $("#total-profit-dark")
                .get(0)
                .getContext("2d");
            // This will get the first returned node in the jQuery collection.
            var barChart = new Chart(barChartCanvas, {
        ...
        if ($("#total-expences-dark").length) {
            ...
            var barChartCanvas = $("#total-expences-dark")
                .get(0)
                .getContext("2d");
            // This will get the first returned node in the jQuery collection.
            var barChart = new Chart(barChartCanvas, {
        ...
        if ($("#device-sales").length) {
            ...
            document.getElementById("device-sales-legend").innerHTML =
        ...
        if ($("#device-sales-dark").length) {
            ...
            var barChartCanvas = $("#device-sales-dark")
                .get(0)
                .getContext("2d");
            // This will get the first returned node in the jQuery collection.
            var barChart = new Chart(barChartCanvas, {
        ...
        if ($("#device-sales-dark-rtl").length) {
            ...
            var barChartCanvas = $("#device-sales-dark-rtl")
                .get(0)
                .getContext("2d");
            // This will get the first returned node in the jQuery collection.
            var barChart = new Chart(barChartCanvas, {
        ...
        if ($("#account-retension").length) {
            ...
            var barChartCanvas = $("#account-retension")
                .get(0)
                .getContext("2d");
            // This will get the first returned node in the jQuery collection.
            var barChart = new Chart(barChartCanvas, {
        ...
        if ($("#page-view-analytic").length) {
                ...
                datasets: [
                    {
                        label: "This week",
                        data: [
                            46, 49, 51, 58, 63.61, 65, 64, 69, 70, 78, 80, 80,
                            90, 85, 87, 92, 97, 102, 107, 109, 111, 111, 120,
                            130, 132, 136, 140, 145,
                        ],
                    ...
                    },
                    {
                        label: "Current week",
                        data: [
                            16, 19, 21, 28, 33.31, 35, 34, 39, 40, 48, 50, 50,
                            51, 55, 57, 62, 67, 69, 68, 70, 72, 75, 74, 80, 79,
                            80, 84, 90,
                        ],
                        backgroundColor: ["rgba(216,247,234, 0.19)"],
                        borderColor: ["#3dd597"],
            ...
            var barChartCanvas = $("#page-view-analytic")
                .get(0)
                .getContext("2d");
            // This will get the first returned node in the jQuery collection.
            var barChart = new Chart(barChartCanvas, {
        ...
        if ($("#page-view-analytic-rtl").length) {
            ...
            var barChartCanvas = $("#page-view-analytic-rtl")
                .get(0)
                .getContext("2d");
            // This will get the first returned node in the jQuery collection.
            var barChart = new Chart(barChartCanvas, {
        ...
        if ($("#prediction-1-dark").length) {
            ...
            var barChartCanvas = $("#prediction-1-dark")
                .get(0)
                .getContext("2d");
            // This will get the first returned node in the jQuery collection.
            var barChart = new Chart(barChartCanvas, {
        ...
        if ($("#prediction-2-dark").length) {
            ...
            var barChartCanvas = $("#prediction-2-dark")
                .get(0)
                .getContext("2d");
            // This will get the first returned node in the jQuery collection.
            var barChart = new Chart(barChartCanvas, {
        ...
        if ($("#prediction-3-dark").length) {
            ...
            var barChartCanvas = $("#prediction-3-dark")
                .get(0)
                .getContext("2d");
            // This will get the first returned node in the jQuery collection.
            var barChart = new Chart(barChartCanvas, {
        ...
        if ($("#prediction-4-dark").length) {
            ...
            var barChartCanvas = $("#prediction-4-dark")
                .get(0)
                .getContext("2d");
            // This will get the first returned node in the jQuery collection.
            var barChart = new Chart(barChartCanvas, {
